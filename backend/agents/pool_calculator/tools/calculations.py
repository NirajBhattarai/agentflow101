...
def calculate_price_from_sqrt_price_x96(
    ...
    try:
        ...
        return {
            ...
            "price_token0_per_token1": 1.0 / price_token1_per_token0
...
def calculate_swap_output(
    ...
    price_impact_percent = (
        abs((effective_price - spot_price) / spot_price) * 100 if spot_price > 0 else 0
    )
...
def process_pool_data(
    ...
    if sqrt_price_x96:
        try:
            ...
            results["insights"].append(
                f"Could not calculate price from sqrtPriceX96: {e}"
            )
